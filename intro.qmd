...
By default, the parameter vector and value of the obective at each step of the iterative fitting process are stored in the `fitlog` field of the model's `optsum` property.
