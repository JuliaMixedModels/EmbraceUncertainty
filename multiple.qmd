...
caterpillar!(Figure(; resolution=(800, 480)), ranefinfo(pnm01, :plate))
```
...
caterpillar!(Figure(; resolution=(800, 160)), ranefinfo(pnm01, :sample))
```
...
draw(
    ...
    mapping(:value => "Bootstrap samples of β"; color=(:names => "Names")) *
...
draw(
    ...
    mapping(:value => "Bootstrap samples of σ"; color=(:group => "Group")) *
    AlgebraOfGraphics.density();
    figure=(; resolution = (800, 450)),
)
```
...
caterpillar!(Figure(resolution=(800, 300)), ranefinfo(psm01, :batch))
```
...
```{julia}
psm01samp = parametricbootstrap(Random.seed!(4567654), 10_000, psm01; hide_progress)
...
qqcaterpillar!(Figure(; resolution=(800, 650)), ranefinfo(iem01, :d))
```
