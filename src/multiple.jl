function penicillindataplot()
    ...
    mp = mapping(:diameter => "Diameter of inhibition zone [mm]", :plate => "Plate", color=:sample)
...
"""
function objgrid(m::LinearMixedModel{T}, xv::AbstractVector{T}, yv::AbstractVector{T}) where {T}
    θ₀ = m.θ
    θ = copy(θ₀)
