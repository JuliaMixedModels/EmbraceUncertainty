...
::: {.callout-note}
RK: I think we will also need some of the other covariates listed in Table 2 of @Balota_2007, at least one of the word frequencies, `Freq_HAL` (or its log value `Log_Freq_HAL`) and the number of syllables :ELP_ldt_item. Are there  arguments againts including all available variables and select here?
