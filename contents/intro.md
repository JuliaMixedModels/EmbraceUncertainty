...
The `MixedModels` package includes several datasets that are used in examples and in tests
of the package.
...
usually an important goal for us.
...
### A Model For the `Dyestuff` Data {#ssec:DyestuffLMM}
