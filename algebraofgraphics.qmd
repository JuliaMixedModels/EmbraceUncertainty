...
The scatterplot is defined by the mapping from the data to the $x$ and $y$ axis of the plots.
...
**TODO:** move legend to bottom using the `legend` keyword argument for `draw`
